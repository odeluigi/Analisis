...
fnyq=Fs/2;
wl=12/fnyq;%frecuencia inferior de la banda de atenuación
%wh=52/fnyq;%frecuencia superior de la banda de atenuación
stop50=fir1(256,wl);%diseño del filtro
...
title('espectro de eeg1 filtrada')
xlabel('frecuencia (Hz)')
ylabel('Amplitud')
%axis([0 180 0 2500])
